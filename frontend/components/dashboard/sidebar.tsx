...
const navItems: { id: Section; label: string; icon: React.ElementType }[] = [
  ...
  { id: "copilot", label: "Co-Pilot", icon: BrainCircuit },
  { id: "investigations", label: "Investigations", icon: Gavel },
    ...
    >
      ...
      <div className="h-16 flex items-center px-4 border-b border-sidebar-border">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg flex items-center justify-center shrink-0 bg-emerald-500/20 border border-emerald-500/30">
            <Activity className="w-5 h-5 text-emerald-500" />
          </div>
          <span
            className={cn(
              "font-mono font-bold tracking-widest text-lg text-emerald-500 whitespace-nowrap transition-all duration-300",
